...
{
    public class AdminBrowseProductViewModel : BindableBase
    {
        ...
        public List<Productmanufacture> Manufacturers { get; set; }

        public ObservableCollection<Productcategory> Categories1 { get; set; }

        public ObservableCollection<Productmanufacture> Manufacturers1 { get; set; }
        ...
        public Productcategory SelectedCategorie { get; set; }

        public Productmanufacture SelectedManufacture { get; set; }
        ...
        public AdminBrowseProductViewModel(PageService pageService, ProductService productService)
        {
        ...
        private void ManufactureMethod(string parametr)
        {
            ...
            else if (parametr.Contains("Редактировать"))
            {
                ...
                idManufacture = SelectedManufacture.ManufactureId;
                Manufacture = SelectedManufacture.ManufactureName;
            }
        }
        ...
        private void CategorieMethod(string parametr)
        {
            ...
            else if (parametr.Contains("Редактировать"))
            {
                ...
                idCategorie = SelectedCategorie.CategoryId;
                Categorie = SelectedCategorie.CategoryName;
            }
        }
